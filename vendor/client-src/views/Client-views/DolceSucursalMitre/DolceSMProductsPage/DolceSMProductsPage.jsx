...
// ---- LOGO ----
import logo from '@/assets/dolce/logo.png';
// <------------
...
export const DolceSMProductsPage = () => {
  ...
  const shareURL = 'https://www.lobo-tech.com.ar/menu/dolce-mitre';
  const cartURL = '/menu/dolce-mitre/cart';

  const bussinessInfo = {
    location: 'Av. Mitre 2747 - 9 de Julio - Bs. As.',
    description: 'SUCURSAL MITRE - HELADERIA ARTESANAL ACOMPAÑANDO MOMENTOS ✨️',
    socialMedia: {
      instagram: 'https://www.instagram.com/dolcepasteleriartesanal',
      share: shareURL,
    },
  ...
  if (loading)
    return <LoadingComponent message={'Cargando...'} theme={dolceTheme} />;
