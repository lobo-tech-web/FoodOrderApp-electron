...
// ---- LOGO ----
import logo from '@/assets/la-nacion/la-nacion-logo.jpg';
// <------------
...
export const LaNacionProductsPage = () => {
  ...
  const shareURL = 'https://www.lobo-tech.com.ar/menu/la-nacion';
  const cartURL = '/menu/la-nacion/cart';

  const bussinessInfo = {
    location: 'Zapiola 598 - Bahia Blanca - Bs. As.',
    description:
      'Panadería y Confiteria - Elaboración y venta de productos panificados y sus derivados ✨️',
    socialMedia: {
      instagram: 'https://www.instagram.com/panaderialanacion',
      share: shareURL,
    },
  ...
  if (loading)
    return <LoadingComponent message={'Cargando...'} theme={laNacionTheme} />;
