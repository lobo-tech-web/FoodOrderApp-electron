...
// ---- LOGO ----
import logo from '@/assets/casanova/logo-casanova.png';
// <------------

// ---- THEME ----
import { casanovaTheme } from '@/theme/Client-theme/casanova-theme.js';
// ---------------
...
// ---- ID DEL CLIENTE ----
const client_id = import.meta.env.VITE_API_CLIENT_CASANOVA_ID;
// <-----------------------

export const CasanovaProductsPage = () => {
  ...
  const shareURL = 'https://www.lobo-tech.com.ar/menu/casanova';
  const cartURL = '/menu/casanova/cart';

  const bussinessInfo = {
    title: 'Casanova',
    location: 'España 601 - Bahia Blanca - Bs. As.',
    description:
      '!Bienvenido! Hace tu pedido para consumir en el local o para retirar ☕️Café de especialidad - 🍰Pastelería de Autor - 🧺Panes de masa madre',
    socialMedia: {
      instagram: 'https://www.instagram.com/casanovabahiablanca',
      share: shareURL,
    },
    orderButtonDescription: 'EAT IN - TAKE AWAY',
  };
  // ----------------------------------------------------
  ...
  if (loading)
    return <LoadingComponent message={'Cargando...'} theme={casanovaTheme} />;

  return (
    <ThemeProvider theme={casanovaTheme}>
      <Box
        sx={{
          display: 'flex',
      ...
      >
        ...
        <ClientProfileBanner
          logo={logo}
          clientInformation={bussinessInfo}
