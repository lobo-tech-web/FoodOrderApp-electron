...
export const CasanovaOrderPreview = () => {
  ...
  const toMainMenuPage = '/menu/casanova';
  ...
  // const orderType = ['RETIRO EN LOCAL', 'CONSUMIR EN LOCAL']; // ESTOS SON LOS TIPOS DE ENTREGA DEL PEDIDO
  const orderType = ['CONSUMIR EN LOCAL', 'RETIRO EN LOCAL'];
