...
// ---- LOGO ----
import logo from '@/assets/wanna-sabores/logo.png';
// <------------
...
export const WannaSaboresProductsPage = () => {
  ...
  // TRAEMOS LOS PRODUCTOS DEL CONTEXT asd
  ...
  const shareURL = 'https://www.lobo-tech.com.ar/menu/wanna-sabores';
  const cartURL = '/menu/wanna-sabores/cart';

  const bussinessInfo = {
    title: 'Wanna Sabores',
    location: 'Vieytes 1802 - Bahia Blanca - Bs. As.',
    description: 'Elaboración y venta de pizzas, empanadas y tartas congeladas',
    socialMedia: {
      instagram: '',
      share: shareURL,
      catalog: 'true',
